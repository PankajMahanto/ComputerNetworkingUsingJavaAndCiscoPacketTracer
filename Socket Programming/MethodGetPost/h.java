...
public class h {
    ...
    public static void main(String[] args) throws MalformedURLException,
        ...
        // first we get the responsecode from the connection, then we test by printing
        // out the code and the responseMessage from URL server
        ...
        // we DO NOT NEED to use GET method, we just read it using inputstream and
        // strings

        // we need string to get printed. so we need a string−type object, where
        // the new URL content will be saved and later on printed
        ...
        // This is the string where each line of the new postings from the URL will be
        // saved
